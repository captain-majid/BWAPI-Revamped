...
- Copy "BWAPI Revamped.exe" inside Starcraft v1.16 folder (where StarCraft.mpq exist), double click "BWAPI Revamped.exe" it'll extract all files to the current folder.
