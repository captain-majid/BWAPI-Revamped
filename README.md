...
- **BWAPI Revamped** already includes [**CoachAI**](https://github.com/captain-majid/CoachAI) or from [here](https://gitea.com/Moataz/CoachAI), which is amazing :heart_eyes: for game practice, amazing :heart_eyes: for replay analysis.
...
# [Download](https://github.com/captain-majid/BWAPI-Revamped/releases/download/v1.2.2/BWAPI.Revamped.exe): :arrow_down:
